...
public class DataCleanManager {
    ...
    public static String TAG = "FileCacheUtils";
    ...
    public static void cleanInternalCache(Context context) {
        Log.i(TAG, "cleanInternalCache: context.getCacheDir():" + context.getCacheDir());
    ...
    private static boolean deleteFilesByDirectory(File directory) {
        Log.i(TAG, "deleteFilesByDirectory: directory:" + directory);
        if (directory != null) {
